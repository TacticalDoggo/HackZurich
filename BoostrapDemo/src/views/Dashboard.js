...
import riskAssessmentData from "../risk-assesment-data";

function Dashboard() {
  const createRiskAssesmentRow = (r) => {
    const route = r.pol_name + ' - ' + r.pod_name_y;
    const severity = r.Severity_delay;
      ...
      <Container fluid>
        ...
        <Row>
          <Col md="6">
            <Card>
              <Card.Header>
                <Card.Title as="h4">Routes Risk Assessment</Card.Title>
                <p className="card-category">Based on historical data of delays</p>
              </Card.Header>
              <Card.Body>
                ...
                <Table className="table-hover">
                  <thead>
                    <tr>
                      ...
                      <th className="border-0">Risk Severity</th>
                    </tr>
                  </thead>
                  <tbody>
                    {riskAssessmentData.map((ra)=> createRiskAssesmentRow(ra))}
                  </tbody>
                </Table>   
              </Card.Body>
              <Card.Footer>
                <div className="legend">
                  ...
                  24-60 days <i className="fas fa-circle text-danger"></i>
                  {">"} 60 days
                </div>
                <hr></hr>
                <div className="stats">
